...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="min-h-screen flex items-center pt-16 pb-8 px-6">
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
            <div className="text-center lg:text-left space-y-4 lg:space-y-6 flex flex-col justify-center">
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-2 md:mb-3 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
                  InsightHouse
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start pt-2">
                <Button
                  ...
                  size="lg-rounded"
                  className="hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  <Link href="/login">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 md:gap-6 text-xs md:text-sm text-muted-foreground pt-2">
                ...
                <span className="flex items-center gap-2">
                  <Check className="h-3 w-3 md:h-4 md:w-4 text-green-500" />5
                  minutos para instalar
                </span>
              </div>
            </div>
            <div className="relative flex items-center justify-center min-h-[300px] md:min-h-[400px] lg:min-h-[450px] h-full">
              <div className="w-full h-full relative flex items-center justify-center">
                <Image
                  src={heroIllustration}
                  alt="Analytics Dashboard"
                  fill
                  className="object-contain dark:invert -mt-12"
                  priority
                />
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              <h3 className="font-semibold text-lg">InsightHouse</h3>
