    ...
    return (
      <Card className="border-2">
        <CardHeader>
          ...
          <CardDescription>Como os usuários navegam no seu site</CardDescription>
        </CardHeader>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center p-4 bg-muted/30 rounded-lg text-center">
            ...
            <div className="text-sm text-muted-foreground">Tempo Médio no Site</div>
          </div>
          ...
          <div className="flex flex-col items-center p-4 bg-muted/30 rounded-lg text-center">
            ...
            <div className="text-2xl font-bold">{data.avgPageDepth.toFixed(1)}</div>
            <div className="text-sm text-muted-foreground">Páginas por Sessão</div>
          </div>
          ...
          <div className="flex flex-col items-center p-4 bg-muted/30 rounded-lg text-center">
            ...
            <div className="text-2xl font-bold">{data.recurrentVisitorsPercentage.toFixed(1)}%</div>
            <div className="text-sm text-muted-foreground">Visitantes Recorrentes</div>
          </div>
        </div>
      </CardContent>
    </Card>
